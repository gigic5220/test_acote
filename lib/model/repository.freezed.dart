...
class _$RepositoryImpl implements _Repository {
  ...
  @override
  String toString() {
    return 'Repository(name: $name, description: $description, stargazersCount: $stargazersCount, language: $language)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, description, stargazersCount, language);
